const questions = [
  ...
  { id: 7, type: "text", text: "Чай, кофе или энергетики?" },
  ...
  { id: 21, type: "text", text: "Какой фильм или мультфильм ты готова пересматривать бесконечно?" },
  { id: 22, type: "text", text: "Если бы ты могла телепортироваться куда угодно прямо сейчас, куда бы мы рванули?" },
  { id: 23, type: "text", text: "Какая эстетика тебе ближе всего? (Дарк академия, уютный софт и т.д.)" },
  { id: 24, type: "text", text: "Твой любимый предмет в школе, если не считать перемену и столовку?" },
  { id: 25, type: "text", text: "Назови три вещи, которые ВСЕГДА есть у тебя в рюкзаке или сумке." },
  { id: 26, type: "text", text: "Какую книгу, комикс или мангу ты бы заставила прочитать всех людей в мире?" },
  ...
  { id: 37, type: "text", text: "Кем ты хотела стать в детстве, когда вырастешь?" },
  ...
  // Блок 5. О вас двоих
  { id: 41, type: "text", text: "Какое у тебя было самое первое впечатление обо мне, когда мы только познакомились в школе?", image: "photo1.jpg" },
  ...
  { id: 44, type: "text", text: "Твой любимый или самый смешной момент из наших переписок?", image: "photo2.jpg" },
  { id: 45, type: "text", text: "Идеальное свидание в твоем понимании — это как?" },
  { id: 46, type: "text", text: "Ты любишь больше говорить или слушать, когда мы общаемся?" },
  { id: 47, type: "text", text: "Что меня (по твоему мнению) может заставить рассмеяться?" },
